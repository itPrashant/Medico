...
export default function Onboard3({ onNext, onSkip }){
  return (
    <div className='onboard bg-white'>
      ...
      <div className='top'>
        <h2 className='text-sm text-green-500 font-bold'>Book Appointments Easily</h2>
        <p className='text-sm text-green-500 font-semibold'>Schedule appointments with your favorite doctors in just a few taps.</p>
      </div>
